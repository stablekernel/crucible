...
- the Watchdog region's `OnTime` and `Overdue` leaves are mutually exclusive, since
  they are sequential leaves of one region, so they are never simultaneously active;
